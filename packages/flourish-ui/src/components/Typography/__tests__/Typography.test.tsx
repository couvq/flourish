...
describe('<Typography />', () => {
  ...
  it('caption is rendered when variant set to caption', () => {
    ...
    expect(caption).toHaveClass('f-caption')
  })
})
